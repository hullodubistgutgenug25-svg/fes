      ...
      <div className="relative z-10 w-full max-w-[1400px] min-[1440px]:max-w-[1500px] min-[1700px]:max-w-[1650px] mx-auto h-full flex flex-col items-center justify-center px-6 md:px-12 pt-20 min-[1440px]:pt-24">
        ...
        >
          <div className="flex items-stretch bg-[#f7f6fd] rounded-t-[24px] rounded-b-none p-2 shadow-[0_-8px_24px_rgba(107,122,144,0.08)] relative">
            ...
            {/* Date Field (Static Anytime) */}
            <div className="flex-1 flex items-center gap-3 px-5 py-4 rounded-xl cursor-default">
            ...
            <div
              ref={locationRef}
              className={`flex-1 flex items-center gap-3 px-5 py-4 cursor-pointer rounded-xl transition-colors duration-200 relative ${activeField === "location" ? "bg-[#f7f6fd]" : "hover:bg-[#f7f6fd]/60"}`}
              onClick={() => {
